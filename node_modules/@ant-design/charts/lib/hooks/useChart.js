...
function useInit(ChartClass, config) {
    ...
    var reactDomToString = function (source, path, type) {
        ...
        (0, util_2.setPath)(source, path, function () {
            ...
            var statisticDom = (0, util_2.isType)(statisticCustomHtml, 'Function')
                ? statisticCustomHtml.apply(void 0, arg) : statisticCustomHtml;
            if ((0, util_2.isType)(statisticDom, 'String') ||
                (0, util_2.isType)(statisticDom, 'Number') ||
                (0, util_2.isType)(statisticDom, 'HTMLDivElement')) {
                return statisticDom;
            }
    ...
    (0, react_1.useEffect)(function () {
        ...
        (0, util_2.getChart)(chartRef, chart.current);
