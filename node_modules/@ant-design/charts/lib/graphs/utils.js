                ...
                case 1:
                    ...
                    if (appendChildrenData) {
                        appendChildrenData = appendChildrenData.map(function (t, index) {
                            var _a;
                            return __assign((_a = {}, _a[constants_1.prefix + "_level"] = g_level_1 + 1, _a[constants_1.prefix + "_parentId"] = g_parentId_1 + "-" + id_1, _a[constants_1.prefix + "_currentPath"] = g_currentPath_1 + "-" + index, _a), t);
                        });
...
var bindSourceMapCollapseEvents = function (graph) {
    var onClick = function (e) {
        ...
        if (e.target.get('name') === 'collapse-icon') {
            ...
            if (!(0, utils_1.isType)(collapsed, 'Boolean')) {
                // @ts-ignore
...
var setTag = function (data, level, parentId, path) {
    ...
    return __assign(__assign((_a = {}, _a[constants_1.prefix + "_level"] = level, _a[constants_1.prefix + "_parentId"] = parentId, _a[constants_1.prefix + "_currentPath"] = path, _a), data), { children: children === null || children === void 0 ? void 0 : children.map(function (item, index) {
            return (0, exports.setTag)(item, level + 1, parentId ? parentId + "-" + id : id, path + "-" + index);
        }) });
};
...
var createLoading = function () {
    ...
    container.className = constants_1.prefix + "-antd-loading";
    var styles = {
        position: 'fixed',
        left: '0',
        top: '0',
...
var closeLoading = function () {
    var hideContainer = document.getElementsByClassName(constants_1.prefix + "-antd-loading");
