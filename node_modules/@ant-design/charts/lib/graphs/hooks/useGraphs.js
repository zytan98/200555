...
function useGraph(graphClass, config, extra) {
    ...
    (0, react_1.useEffect)(function () {
        if (graph && !graph.destroyed) {
            ...
            graphData.current = (0, util_2.deepClone)(data);
            changeData();
        }
    }, [data]);
    (0, react_1.useEffect)(function () {
        ...
        if (container.current && graphClass) {
            ...
            if (markerCfg) {
                ...
                sourceGraph.includes(name_1)
                    ? (0, utils_1.bindSourceMapCollapseEvents)(graph_1)
                    : (0, utils_1.bindDefaultEvents)(graph_1, level, getChildren);
            }
    ...
    (0, react_1.useEffect)(function () {
        if (graphRef.current && toolbarCfg) {
            (0, components_1.createToolbar)({ graph: graphRef.current, container: container.current, toolbarCfg: toolbarCfg });
        }
    }, [graphRef, toolbarCfg]);
    (0, react_1.useEffect)(function () {
        if (graphRef.current && tooltipCfg) {
            (0, components_1.createTooltip)({ graph: graphRef.current, container: container.current, tooltipCfg: tooltipCfg, nodeCfg: nodeCfg });
        }
    }, [graphRef, tooltipCfg]);
    (0, react_1.useEffect)(function () {
        return function () {
