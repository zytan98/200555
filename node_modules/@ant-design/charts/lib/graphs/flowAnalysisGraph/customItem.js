...
var registerIndicatorCardNode = function () {
    ...
    g6_1.default.registerNode('indicator-card', {
        ...
        draw: function (cfg, group) {
            ...
            if (title) {
                ...
                titleTextShape = group.addShape('text', {
                    attrs: __assign({ x: paddingArray[3], y: paddingArray[0], textBaseline: 'top', text: autoEllipsis ? (0, utils_1.useEllipsis)(title, textStyle === null || textStyle === void 0 ? void 0 : textStyle.fontSize, contentWidth) : title }, textStyle),
                    name: 'title',
                });
        ...
        setState: function (name, value, item) {
            ...
            var stateName = (0, util_1.isBoolean)(value) ? name : name + ":" + value;
