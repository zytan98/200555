...
import MultiView from './plots/mix';
import Mix from './plots/mix';
import BidirectionalBar from './plots/bidirectionalBar';
import { G2 } from '@antv/g2plot';
export { Area, Bar, Box, Bullet, Column, Funnel, Histogram, Line, Liquid, Heatmap, Pie, Progress, Radar, Facet, RingProgress, Rose, Scatter, TinyArea, TinyColumn, Violin, TinyLine, Waterfall, WordCloud, Sunburst, DualAxes, Stock, RadialBar, Gauge, BidirectionalBar, Sankey, MultiView, Mix, G2, };
