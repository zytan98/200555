...
exports.default = exports.TEXT_STYLE = exports.ARROW_STYLE = exports.BACKGROUND_STYLE = void 0;
...
function () {
  ...
  TimeBarTooltip.prototype.render = function () {
    ...
    var container = (0, _domUtil.createDom)("<div class='" + className + "' style=\"position: absolute; width: fit-content; height: fit-content; opacity: " + opacity + "\"></div>");
    ...
    var arrow = (0, _domUtil.createDom)("<div style='position: absolute; width: 0px; height: 0px; border-left: 5px solid transparent; border-right: 5px solid transparent; border-top: 10px solid " + backgroundColor + "'></div>");
